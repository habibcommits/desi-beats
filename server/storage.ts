...
export class MemStorage implements IStorage {
  ...
  private seedData() {
    ...
    const menuItems: InsertMenuItem[] = [
      // Breakfast
      { categoryId: getCategoryId("breakfast"), name: "Whole Wheat Paratha", price: 80, description: "Healthy whole wheat paratha", order: 1, available: true, featured: false, image: "/chicken_paratha_breakfast_plate.png" },
      ...
      { categoryId: getCategoryId("breakfast"), name: "Chicken Paratha", price: 250, description: "Chicken stuffed paratha", order: 4, available: true, featured: true, image: "/chicken_paratha_breakfast_plate.png" },
      ...
      { categoryId: getCategoryId("halwa-puri"), name: "Halwa Puri Nashta Deal", price: 450, description: "2 Puri + Plate Aloo + Cup Halwa", order: 6, available: true, featured: true, image: "/halwa_puri_nashta_platter.png" },
      ...
      // Karahi
      { categoryId: getCategoryId("karahi"), name: "Chicken Karahi Half", price: 1150, description: "Half portion chicken karahi", order: 1, available: true, featured: true, image: "/chicken_karahi_in_pot.png" },
      { categoryId: getCategoryId("karahi"), name: "Chicken Karahi Full", price: 2250, description: "Full portion chicken karahi", order: 2, available: true, featured: true, image: "/chicken_karahi_in_pot.png" },
      ...
      { categoryId: getCategoryId("rice"), name: "Chicken Pulao", price: 480, description: "Chicken pulao rice", order: 3, available: true, featured: false, image: "/chicken_biryani_bowl.png" },
      { categoryId: getCategoryId("rice"), name: "Chicken Bariyani", price: 590, description: "Spiced chicken biryani", order: 4, available: true, featured: true, image: "/chicken_biryani_bowl.png" },
      ...
      // BBQ
      { categoryId: getCategoryId("bbq"), name: "Chicken Tikka Boti", price: 200, description: "Chicken tikka pieces", order: 1, available: true, featured: true, image: "/bbq_chicken_tikka_skewers.png" },
      ...
      { categoryId: getCategoryId("bbq"), name: "Malai Boti 6 Seekh", price: 2400, description: "6 seekh malai boti", order: 6, available: true, featured: true, image: "/bbq_chicken_tikka_skewers.png" },

      // Burgers
      { categoryId: getCategoryId("burgers"), name: "Zinger Burger with Fries", price: 350, description: "Crispy zinger burger with fries", order: 1, available: true, featured: true, image: "/zinger_chicken_burger.png" },
      ...
      // Shawarma
      { categoryId: getCategoryId("shawarma"), name: "Chicken Shawarma", price: 220, description: "Chicken shawarma wrap", order: 1, available: true, featured: true, image: "/chicken_shawarma_wrap.png" },
      ...
      // Fried Chicken
      { categoryId: getCategoryId("fried-chicken"), name: "Chicken Hot Shots", price: 450, description: "Spicy chicken shots (Half)", order: 1, available: true, featured: true, image: "/crispy_fried_chicken.png" },
      ...
      // Hot Wings
      { categoryId: getCategoryId("hot-wings"), name: "Masala Hot Wings 6 pcs", price: 650, description: "Spicy masala wings", order: 1, available: true, featured: true, image: "/spicy_buffalo_hot_wings.png" },
      ...
      // Fries & Refreshments
      { categoryId: getCategoryId("fries"), name: "Plain Fries", price: 200, description: "Regular portion", order: 1, available: true, featured: false, image: "/golden_french_fries.png" },
